...
{
    public partial class SetSavings : Form
    {
        public SetSavings()
        {
            InitializeComponent();
        ...
        private void btnSet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (savingsToAdd > GlobalVariables.RemBudget)
                {
                    MessageBox.Show("Exceeds Remaining Budget!");
                    return;
                }
                ...
                using (OleDbConnection connection = new OleDbConnection(connectionString))
                {
                    ...
                    using (OleDbCommand checkCommand = new OleDbCommand(checkQuery, connection))
                    {
                        ...
                        {
                            string insertQuery = "INSERT INTO Savings (ID, Savings) VALUES (@ID, @savingsToAdd)";
